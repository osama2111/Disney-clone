  ...
  return (
    <div className='flex justify-center items-center flex-wrap mt-8 mb-8'>
      {productionHouses.map((house) => (
        <div key={house.name} className="group gap-4 relative w-80 h-48 cursor-pointer overflow-hidden border-2 border-gray-300 rounded-lg m-4 transition-transform transform hover:scale-105">
